...
def gradient_descent(gamma, learning_rate, x, y, iterations):
	...
	#total error
	J = cost(m, t0, t1, x, y)
	velocity0 = np.zeros((iterations))
	velocity1 = np.zeros((iterations))
	...
	for it in range(iterations):
		...
		velocity0[it] = gamma*velocity0[it] + learning_rate*grad0
		velocity1[it] = gamma*velocity1[it] + learning_rate*grad1
